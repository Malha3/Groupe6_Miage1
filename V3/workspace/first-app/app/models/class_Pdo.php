...
public function verification_Utilisateur($login,$password)
{
	...
	{	
		...
		$_SESSION['operateur']= 'operateur'; // Permet de connaite le type de l'utilisateur : Opérateur, Gestionnaire,..
		...
		if ($resultatEmpl){
			...
			$_SESSION['employe']= 'employe'; // Permet de connaite le type de l'utilisateur : Opérateur, Gestionnaire,..
			//$_SESSION['login'] = $login;
			...
			if($resultatGest){
						...
						//session_start();
					$_SESSION['idGestionnaire'] = $resultat['idGestionnaire'];
					$_SESSION['idEmploye'] = $resultat['idEmploye'];
					$_SESSION['gestionnaire']= 'gestionnaire'; // Permet de connaite le type de l'utilisateur : Opérateur, Gestionnaire,..
					//$_SESSION['login'] = $login;
