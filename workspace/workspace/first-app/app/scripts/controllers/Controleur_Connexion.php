...
// on vérifie les informations du formulaire, à savoir si le pseudo saisi est bien un pseudo autorisé, de même pour le mot de passe
    ...
    // on enregistre les paramètres de notre visiteur comme variables de session ($login et $pwd) (notez bien que l'on utilise pas le $ pour enregistrer ces variables)
        ...
        $_SESSION['idGestionnaire'] = PdoGm::idGestionnaire($login);
        
       

    // on redirige notre visiteur vers une page de notre section membre
       // require_once ('C:\xampp\htdocs\workspace\first-app\app\views\Accueil_G.php');
        if(PdoGm::operateur_user($_SESSION['login'])==true)
        {
            require_once ('C:\xampp\htdocs\workspace\first-app\app\views\Accueil_Op.php');
        }
        else
            {
            if(PdoGm::gestionnaire_user($_SESSION['login'])==true)
            {
                ...
                {
                    require_once ('C:\xampp\htdocs\workspace\first-app\app\views\Accueil_Em.php');
                }
                else
                {
