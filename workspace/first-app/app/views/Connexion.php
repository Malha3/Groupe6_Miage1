				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="/workspace/first-app/app/views/sidebar-left.html">Left Sidebar</a></li>
							<li><a href="/workspace/first-app/app/views/sidebar-right.html">Right Sidebar</a></li>
						</ul>
					</li>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">Pour vous connecter, veuillez saisir votre identifiant et mot de passe.. <a href="signup.html">Register</a> adipisicing elit. Quo nulla quibusdam cum doloremque incidunt nemo sunt a tenetur omnis odio. </p>
							<hr>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						...
						<div class="widget-body">
							<p>Pour vous connecter, veuiilez saisir votre identifiant et votre mot de passe..</p>
						</div>
					</div>
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<a href="/workspace/first-app/app/views/sidebar-right.html">Sidebar</a> |
